...
from .serializers import FlightSerializer, BookingSerializer, BookingDetailsSerializer, UpdateBookingSerializer, RegisterSerializer, AUpdateBookingSerializer
...
class BookFlight(CreateAPIView):
	serializer_class = AUpdateBookingSerializer
...
class UpdateBooking(RetrieveUpdateAPIView):
	...
	def get_serializer_class(self):
		if self.request.user.is_staff:
			return AUpdateBookingSerializer
		else:
